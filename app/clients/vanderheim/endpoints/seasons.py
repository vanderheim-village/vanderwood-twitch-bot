...
class SeasonsAPI:
    ...
    def _fetch_season_clan_spoils_sessions_page(self, season_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_season_clan_spoils_session(self, season_id: str, clan_spoils_session_id: str) -> Dict[str, Any]:
        """
    ...
    def create_season_clan_spoils_session(self, season_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_season_clan_spoils_session(self, season_id: str, clan_spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_clan_spoils_session(self, season_id: str, clan_spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_season_clan_spoils_session(self, season_id: str, clan_spoils_session_id: str) -> None:
        """
    ...
    def _fetch_season_clan_spoils_session_claims_page(self, season_id: str, clan_spoils_session_id: str,  page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_season_clan_spoils_session_claims(self, season_id: str, clan_spoils_session_id: str) -> Dict[str, Any]:
        """
    ...
    def fetch_season_clan_spoils_session_claim(self, season_id: str, clan_spoils_session_id: str, clan_spoils_claim_id: str) -> Dict[str, Any]:
        """
    ...
    def create_season_clan_spoils_session_claim(self, season_id: str, clan_spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_season_clan_spoils_session_claim(self, season_id: str, clan_spoils_session_id: str, clan_spoils_claim_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_clan_spoils_session_claim(self, season_id: str, clan_spoils_session_id: str, clan_spoils_claim_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_season_clan_spoils_session_claim(self, season_id: str, clan_spoils_session_id: str, clan_spoils_claim_id: str) -> None:
        """
    ...
    def _fetch_season_points_page(self, season_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def update_season_point(self, season_id: str, point_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_point(self, season_id: str, point_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _fetch_season_raid_sessions_page(self, season_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def update_season_raid_session(self, season_id: str, raid_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_raid_session(self, season_id: str, raid_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _fetch_season_raid_session_checkins_page(self, season_id: str, raid_session_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_season_raid_session_checkins(self, season_id: str, raid_session_id: str) -> Dict[str, Any]:
        """
    ...
    def fetch_season_raid_session_checkin(self, season_id: str, raid_session_id: str, raid_checkin_id: str) -> Dict[str, Any]:
        """
    ...
    def create_season_raid_session_checkin(self, season_id: str, raid_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_season_raid_session_checkin(self, season_id: str, raid_session_id: str, raid_checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_raid_session_checkin(self, season_id: str, raid_session_id: str, raid_checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_season_raid_session_checkin(self, season_id: str, raid_session_id: str, raid_checkin_id: str) -> None:
        """
    ...
    def _fetch_season_sentry_sessions_page(self, season_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def update_season_sentry_session(self, season_id: str, sentry_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_sentry_session(self, season_id: str, sentry_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _fetch_season_sentry_session_checkins_page(self, season_id: str, sentry_session_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_season_sentry_session_checkins(self, season_id: str, sentry_session_id: str) -> Dict[str, Any]:
        """
    ...
    def fetch_season_sentry_session_checkin(self, season_id: str, sentry_session_id: str, sentry_checkin_id: str) -> Dict[str, Any]:
        """
    ...
    def create_season_sentry_session_checkin(self, season_id: str, sentry_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_season_sentry_session_checkin(self, season_id: str, sentry_session_id: str, sentry_checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_sentry_session_checkin(self, season_id: str, sentry_session_id: str, sentry_checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_season_sentry_session_checkin(self, season_id: str, sentry_session_id: str, sentry_checkin_id: str) -> None:
        """
    ...
    def _fetch_season_sessions_page(self, season_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def update_season_session(self, season_id: str, session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_session(self, season_id: str, session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _fetch_season_session_checkins_page(self, season_id: str, session_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_season_session_checkin(self, season_id: str, session_id: str, checkin_id: str) -> Dict[str, Any]:
        """
    ...
    def create_season_session_checkin(self, season_id: str, session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_season_session_checkin(self, season_id: str, session_id: str, checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_session_checkin(self, season_id: str, session_id: str, checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_season_session_checkin(self, season_id: str, session_id: str, checkin_id: str) -> None:
        """
    ...
    def _fetch_season_spoils_sessions_page(self, season_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def update_season_spoils_session(self, season_id: str, spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_spoils_session(self, season_id: str, spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _fetch_season_spoils_session_claims_page(self, season_id: str, spoils_session_id: str, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_season_spoils_session_claims(self, season_id: str, spoils_session_id: str) -> Dict[str, Any]:
        """
    ...
    def fetch_season_spoils_session_claim(self, season_id: str, spoils_session_id: str, spoils_claim_id: str) -> Dict[str, Any]:
        """
    ...
    def create_season_spoils_session_claim(self, season_id: str, spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_season_spoils_session_claim(self, season_id: str, spoils_session_id: str, spoils_claim_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_season_spoils_session_claim(self, season_id: str, spoils_session_id: str, spoils_claim_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_season_spoils_session_claim(self, season_id: str, spoils_session_id: str, spoils_claim_id: str) -> None:
        """
