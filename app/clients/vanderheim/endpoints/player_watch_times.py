...
class PlayerWatchTimesAPI:
    ...
    async def _fetch_player_watch_times_page(
    ...
    async def update_player_watch_time(
        self, player_watch_time_id: str, data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    async def partial_update_player_watch_time(
        self, player_watch_time_id: str, data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
