...
class SpoilsSessionsAPI:
    ...
    def _fetch_spoils_sessions_page(self, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def partial_update_spoils_session(self, spoils_session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
