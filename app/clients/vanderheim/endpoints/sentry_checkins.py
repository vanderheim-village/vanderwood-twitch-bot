...
class SentryCheckinsAPI:
    ...
    def _fetch_sentry_checkins_page(self, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def partial_update_sentry_checkin(self, sentry_checkin_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
