...
class SpoilsClaimsAPI:
    ...
    def _fetch_spoils_claims_page(self, page: Optional[int] = None, page_size: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def fetch_all_spoils_claims(self) -> Dict[str, Any]:
        """
        ...
        page = 1
        while True:
            response = self._fetch_spoils_claims_page(page=page)
    ...
    def fetch_spoils_claim(self, spoils_claim_id: str) -> Dict[str, Any]:
        """
    ...
    def create_spoils_claim(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def update_spoils_claim(self, spoils_claim_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def partial_update_spoils_claim(self, spoils_claim_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def delete_spoils_claim(self, spoils_claim_id: str) -> None:
        """
